    ...
    <Fragment>
      <section id='techStack'>
        ...
        <div className='w-fit m-auto rounded-lg border border-black dark:border-white border-solid overflow-hidden'>
          <button
            className={`w-[150px] p-2 font-bold ${
        ...
        <div className='flex items-center min-h-[450px] py-[30px] px-[20px] md:px-[100px] shadow-zinc-300 dark:shadow-zinc-700 shadow-xl flex-wrap justify-center gap-5'>
