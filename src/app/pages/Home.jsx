...
const Home = () => {
  ...
  return (
    <Fragment>
      <div className='min-h-[100vh] mx-[20px] md:mx-[100px] lg:mx-[200px] pt-[80px] md:pt-0 md:flex items-center justify-between'>
        <div>
        ...
        <div
          className='bg-[url(/images/profile.png)] w-[300px] h-[300px] bg-cover rounded-full bg-gray-500 hover:cursor-pointer hover:bg-blend-multiply m-auto md:m-0 mt-[40px] md:mt-0'
          ref={profileRef}
        >
          {showResume ? (
            <Link
